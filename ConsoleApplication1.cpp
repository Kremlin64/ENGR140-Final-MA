...
int main() {
    ...
    cout << "===== Welcome to the Budget & Loan Calculator =====\n";
    ...
    while (running) {
        ...
        case 2: addIncome(acc); break;
        case 3: addExpense(acc); break;
        case 4: withdraw(acc); break;
        case 5: calculateLoan(); break;
        case 6: showSummary(acc); break;
        case 7:
            cout << "Saving data and exiting...\n";
            saveData(username, acc);
            running = false;
            break;
        default:
